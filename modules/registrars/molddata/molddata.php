...
function molddata_getConfigArray() {
 $configarray = array(
  ...
  "write_log" => array( 'FriendlyName' => 'Write Log', "Type" => "yesno", "Description" => "Write module logs"),
  "write_log_info" => array( 'FriendlyName' => 'Write Log DomainInfo', "Type" => "yesno", "Description" => "Write module log even for EPP:DomainInfo"),
  "force_def_contact" => array( 'FriendlyName' => 'Force default contact', "Type" => "yesno", "Description" => "Use default contact details for Technical and Billing"),
  
  "def_firstname" => array( 'FriendlyName' => 'Default First Name', "Type" => "text", "Size" => "40", "Description" => "First Name for billing and technical"),
  "def_lastname" => array( 'FriendlyName' => 'Default Last Name', "Type" => "text", "Size" => "40", "Description" => "Last Name for billing and technical"),
  "def_email" => array( 'FriendlyName' => 'Default Email', "Type" => "text", "Size" => "40", "Description" => "Email for billing and technical"),
  "def_address1" => array( 'FriendlyName' => 'Default Address', "Type" => "text", "Size" => "40", "Description" => "Address for billing and technical"),
  "def_city" => array( 'FriendlyName' => 'Default City', "Type" => "text", "Size" => "40", "Description" => "City for billing and technical"),
  "def_state" => array( 'FriendlyName' => 'Default State', "Type" => "text", "Size" => "40", "Description" => "State for billing and technical"),
  "def_postcode" => array( 'FriendlyName' => 'Default Postcode', "Type" => "text", "Size" => "40", "Description" => "Postcode for billing and technical"),
  "def_country" => array( 'FriendlyName' => 'Default Country', "Type" => "text", "Size" => "40", "Description" => "Country for billing and technical"),
  "def_phone" => array( 'FriendlyName' => 'Default Phone', "Type" => "text", "Size" => "40", "Description" => "Phone for billing and technical"),
  );
 return $configarray;
}
