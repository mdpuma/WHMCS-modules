...
function bpaycardeur_link($params)
{
    ...
    $xmldata   = "<payment>
                ...
                <callback_url>" . htmlspecialchars($systemurl . '/modules/gateways/callback/bpaycardeur.php') . "</callback_url>
                <lang>en</lang>
...
function bpaycardeur_capture($params) {
...
/*
function bpaycardeur_refund($params) {
