...
function bpaycard_link($params)
{
    ...
    $xmldata   = "<payment>
                ...
                <callback_url>" . htmlspecialchars($systemurl . '/modules/gateways/callback/bpaycard.php') . "</callback_url>
                <lang>en</lang>
...
function bpaycard_capture($params) {
...
/*
function bpaycard_refund($params) {
