...
function bpaywmz_link($params)
{
    ...
    $xmldata   = "<payment>
                ...
                <callback_url>" . htmlspecialchars($systemurl . '/modules/gateways/callback/bpaywmz.php') . "</callback_url>
                <lang>en</lang>
...
function bpaywmz_capture($params) {
...
/*
function bpaywmz_refund($params) {
