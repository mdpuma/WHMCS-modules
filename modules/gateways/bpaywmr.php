...
function bpaywmr_link($params)
{
    ...
    $xmldata   = "<payment>
                ...
                <callback_url>" . htmlspecialchars($systemurl . '/modules/gateways/callback/bpaywmr.php') . "</callback_url>
                <lang>en</lang>
...
function bpaywmr_capture($params) {
...
/*
function bpaywmr_refund($params) {
